...
export const scaleNames: Record<string, {code: string, name: string}> = {
  '1': {code: 'Y', name: 'مطلوبیت'},
  '2': {code: 'Z', name: 'تنزل'},
  '3': {code: '1', name: 'اسکیزوئید'},
  '4': {code: '2', name: 'اجتنابی'},
  '5': {code: '3', name: 'وابسته'},
  '6': {code: '4', name: 'هیستریونیک'},
  '7': {code: '5', name: 'خودشیفته'},
  '8': {code: '6A', name: 'ضد اجتماعی'},
  '9': {code: '6B', name: 'پرخاشگر/سادیست'},
  '10': {code: '7', name: 'وسواسی'},
  '11': {code: '8A', name: 'منفعل-پرخاشگر'},
  '12': {code: '8B', name: 'خودشکن'},
  '13': {code: 'S', name: 'اسکیزوتایپال'},
  '14': {code: 'C', name: 'خط مرزی'},
  '15': {code: 'P', name: 'پارانوئید'},
  '16': {code: 'A', name: 'اضطراب'},
  '17': {code: 'H', name: 'شبه‌جسمانی'},
  '18': {code: 'N', name: 'دوقطبی: مانیک'},
  '19': {code: 'D', name: 'دیستیمیا'},
  '20': {code: 'B', name: 'وابستگی به الکل'},
  '21': {code: 'T', name: 'وابستگی به مواد مخدر'},
  '22': {code: 'SS', name: 'اختلال تفکر'},
  '23': {code: 'CC', name: 'افسردگی اساسی'},
  '24': {code: 'PP', name: 'اختلال هذیانی'},
  '25': {code: 'V', name: 'روایی'},
};
